"""
CNN + BiLSTM + Multi-Head Attention 联邦交通流预测模型（基础版）
...
- BiLSTM 提取时间序列特征
- CNN 和 LSTM 输出堆叠为 (B, 2, hidden_dim) 的特征序列
...
def parse_args():
    parser = argparse.ArgumentParser(description="CNN + BiLSTM + Multi-Head Attention 联邦交通流预测（基础版）")
    ...
    parser.add_argument("--output-dir", type=str, default="results/cnn_fed_base")
...
# ============================================================
# CNN + BiLSTM + Multi-Head Attention 模型
# ============================================================

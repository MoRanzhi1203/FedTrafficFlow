...
| **收敛性和稳健性** | 每 round loss + RMSE 曲线 | 实验 1 有完整 `convergence_history.json` (20 rounds × 6 metrics)。实验 5/6 formal 有 convergence_history 但训练失效。实验 3 仅 smoke r1e1（无收敛曲线）。 | 补 exp3/5/6 的 round-level 收敛记录；exp5/6 修复 scaler 后重跑才能获得有意义的收敛曲线 |

...
class ExperimentConfig:
    ...
    experiment_name: str = "single_intersection_ablation"
    seed: int = 42
    input_path: str = "data/analysis/node_intersection_flow_parquet"
    output_dir: str = "results/real_data_experiments/single_intersection_ablation"
    num_clients: int = 5
...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--output-dir", type=str, default="results/real_data_experiments/single_intersection_ablation")

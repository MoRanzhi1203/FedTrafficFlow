...
- 主结果 summary: `E:\Jupter_Notebook\FedTrafficFlow\results\rdm_exp\scenarios\g_mcar_pt\summaries\imputation_quality_summary_exclude_warmup.csv`
- 流量组 summary: `E:\Jupter_Notebook\FedTrafficFlow\results\rdm_exp\scenarios\g_mcar_pt\summaries\imputation_quality_by_flow_group.csv`
...
- 当前所有图件均基于 masked-position imp error，不代表 FedAvg / Independent 交通流预测性能。
